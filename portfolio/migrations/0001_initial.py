    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtitle', models.CharField(max_length=63, unique=True, verbose_name='Subtitle')),
                ('image', models.ImageField(help_text='Recommended resolution: 1040px * 585px', null=True, upload_to='projects/', verbose_name='Image')),
                ('thumbnail', models.ImageField(help_text='Recommended resolution: 150px * 150px', null=True, upload_to='projects/', verbose_name='Thumbnail')),
